			...
			async with _package_lock:
				if _package_ref is ...:
					...
					parameterization = resource_pb2.Parameterization(
						name="cloudinit-tailscale",
						version=get_version(),
						value=base64.b64decode("ewogICJtb2R1bGUiOiAiZ2l0aHViLmNvbS90YWlsc2NhbGUvdGVycmFmb3JtLWNsb3VkaW5pdC10YWlsc2NhbGUiLAogICJwYWNrYWdlTmFtZSI6ICJjbG91ZGluaXQtdGFpbHNjYWxlIgp9"),
					)
