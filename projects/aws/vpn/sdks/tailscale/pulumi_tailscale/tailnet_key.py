...
class TailnetKeyArgs:
    def __init__(__self__, *,
                 ...
                 expiry: Optional[pulumi.Input[_builtins.float]] = None,
        ...
        :param pulumi.Input[_builtins.float] expiry: The expiry of the key in seconds. Defaults to `7776000` (90 days).
        :param pulumi.Input[_builtins.bool] preauthorized: Determines whether or not the machines authenticated by the key will be authorized for the tailnet by default. Defaults
               to `false`.
        :param pulumi.Input[_builtins.str] recreate_if_invalid: Determines whether the key should be created again if it becomes invalid. By default, reusable keys will be recreated,
    ...
    @_builtins.property
    @pulumi.getter
    def expiry(self) -> Optional[pulumi.Input[_builtins.float]]:
        """
    ...
    @expiry.setter
    def expiry(self, value: Optional[pulumi.Input[_builtins.float]]):
...
class TailnetKey(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def expiry(self) -> pulumi.Output[_builtins.float]:
        """
        The expiry of the key in seconds. Defaults to `7776000` (90 days).
        """
        return pulumi.get(self, "expiry")
