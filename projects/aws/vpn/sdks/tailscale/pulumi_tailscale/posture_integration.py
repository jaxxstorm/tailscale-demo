...
class PostureIntegrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] posture_provider: The third-party provider for posture data. Valid values are `falcon`, `fleet`, `huntress`, `intune`, `jamfpro`,
               `kandji`, `kolide`, and `sentinelone`.
    ...
    def posture_provider(self) -> pulumi.Input[_builtins.str]:
        """
        The third-party provider for posture data. Valid values are `falcon`, `fleet`, `huntress`, `intune`, `jamfpro`,
        `kandji`, `kolide`, and `sentinelone`.
        """
...
class PostureIntegration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a PostureIntegration resource with the given unique name, props, and options.
