...
class DnsConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DnsConfigurationNameserverArgs']]] nameservers: Set the nameservers used by devices on your network to resolve DNS queries. `override_local_dns` must also be true to
               prefer these nameservers over local DNS configuration.
        :param pulumi.Input[_builtins.bool] override_local_dns: When enabled, use the configured DNS servers in `nameservers` to resolve names outside the tailnet. When disabled,
               devices will prefer their local DNS configuration. Defaults to false.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DnsConfigurationSplitDnArgs']]] split_dns: Set the nameservers used by devices on your network to resolve DNS queries on specific domains (requires Tailscale v1.8
               or later). Configuration does not depend on `override_local_dns`.
        """
    ...
    def nameservers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DnsConfigurationNameserverArgs']]]]:
        """
        Set the nameservers used by devices on your network to resolve DNS queries. `override_local_dns` must also be true to
        prefer these nameservers over local DNS configuration.
        """
    ...
    def override_local_dns(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
        When enabled, use the configured DNS servers in `nameservers` to resolve names outside the tailnet. When disabled,
        devices will prefer their local DNS configuration. Defaults to false.
        """
    ...
    def split_dns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DnsConfigurationSplitDnArgs']]]]:
        """
        Set the nameservers used by devices on your network to resolve DNS queries on specific domains (requires Tailscale v1.8
        or later). Configuration does not depend on `override_local_dns`.
        """
...
class DnsConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DnsConfiguration resource with the given unique name, props, and options.

        :param str resource_name: The name of the resource.
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.bool] magic_dns: Whether or not to enable MagicDNS. Defaults to true.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DnsConfigurationNameserverArgs', 'DnsConfigurationNameserverArgsDict']]]] nameservers: Set the nameservers used by devices on your network to resolve DNS queries. `override_local_dns` must also be true to
               prefer these nameservers over local DNS configuration.
        :param pulumi.Input[_builtins.bool] override_local_dns: When enabled, use the configured DNS servers in `nameservers` to resolve names outside the tailnet. When disabled,
               devices will prefer their local DNS configuration. Defaults to false.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] search_paths: Additional search domains. When MagicDNS is on, the tailnet domain is automatically included as the first search domain.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DnsConfigurationSplitDnArgs', 'DnsConfigurationSplitDnArgsDict']]]] split_dns: Set the nameservers used by devices on your network to resolve DNS queries on specific domains (requires Tailscale v1.8
               or later). Configuration does not depend on `override_local_dns`.
        """
        ...
    @overload
