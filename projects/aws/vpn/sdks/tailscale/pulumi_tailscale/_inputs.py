...
class DnsConfigurationSplitDnArgsDict(TypedDict):
    ...
    """
    nameservers: NotRequired[pulumi.Input[Sequence[pulumi.Input['DnsConfigurationSplitDnNameserverArgsDict']]]]
    """
...
class DnsConfigurationSplitDnArgs:
    def __init__(__self__, *,
                 domain: pulumi.Input[_builtins.str],
                 nameservers: Optional[pulumi.Input[Sequence[pulumi.Input['DnsConfigurationSplitDnNameserverArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def nameservers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DnsConfigurationSplitDnNameserverArgs']]]]:
        """
        Set the nameservers used by devices on your network to resolve DNS queries.
        """
    ...
    @nameservers.setter
    def nameservers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DnsConfigurationSplitDnNameserverArgs']]]]):
...
class GetUsersUserArgs:
    def __init__(__self__, *,
        ...
        :param _builtins.float device_count: Number of devices the user owns.
    ...
    @device_count.setter
    def device_count(self, value: _builtins.float):
