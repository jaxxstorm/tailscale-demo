...
class TailnetSettingsArgs:
    def __init__(__self__, *,
                 ...
                 devices_key_duration_days: Optional[pulumi.Input[_builtins.float]] = None,
        ...
        :param pulumi.Input[_builtins.float] devices_key_duration_days: The key expiry duration for devices on this tailnet
    ...
    def devices_key_duration_days(self) -> Optional[pulumi.Input[_builtins.float]]:
        """
    ...
    def devices_key_duration_days(self, value: Optional[pulumi.Input[_builtins.float]]):
...
class TailnetSettings(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a TailnetSettings resource with the given unique name, props, and options.
    ...
    @_builtins.property
    @pulumi.getter(name="devicesKeyDurationDays")
    def devices_key_duration_days(self) -> pulumi.Output[_builtins.float]:
        """
        The key expiry duration for devices on this tailnet
        """
        return pulumi.get(self, "devices_key_duration_days")
