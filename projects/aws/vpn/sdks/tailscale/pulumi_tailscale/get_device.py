...
def get_device(hostname: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tailscale:index/getDevice:getDevice', __args__, opts=opts, typ=GetDeviceResult, package_ref=_utilities.get_package()).value
...
def get_device_output(hostname: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tailscale:index/getDevice:getDevice', __args__, opts=opts, typ=GetDeviceResult, package_ref=_utilities.get_package())
