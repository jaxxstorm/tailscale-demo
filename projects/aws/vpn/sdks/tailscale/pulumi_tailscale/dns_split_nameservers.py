...
class DnsSplitNameserversArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] domain: Domain to configure split DNS for. Requests for this domain will be resolved using the provided nameservers. Changing
...
class DnsSplitNameservers(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DnsSplitNameservers resource with the given unique name, props, and options.
