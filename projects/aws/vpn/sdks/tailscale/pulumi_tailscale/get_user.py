...
class GetUserResult:
    ...
    def __init__(__self__, created=None, currently_connected=None, device_count=None, display_name=None, id=None, last_seen=None, login_name=None, profile_pic_url=None, role=None, status=None, tailnet_id=None, type=None):
        ...
        if device_count and not isinstance(device_count, float):
            raise TypeError("Expected argument 'device_count' to be a float")
...
def get_user(id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('tailscale:index/getUser:getUser', __args__, opts=opts, typ=GetUserResult, package_ref=_utilities.get_package()).value
...
def get_user_output(id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('tailscale:index/getUser:getUser', __args__, opts=opts, typ=GetUserResult, package_ref=_utilities.get_package())
