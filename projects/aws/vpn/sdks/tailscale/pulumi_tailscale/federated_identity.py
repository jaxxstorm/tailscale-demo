...
class FederatedIdentityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] subject: The pattern used when matching against the `sub` claim from an OIDC identity token. Patterns can include `*` characters
               to match against any character.
        :param pulumi.Input[_builtins.str] audience: The value used when matching against the `aud` claim from an OIDC identity token. Specifying the audience is optional as
               Tailscale will generate a secure audience at creation time by default. It is recommended to let Tailscale generate the
               audience unless the identity provider you are integrating with requires a specific audience format.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] custom_claim_rules: A map of claim names to pattern strings used to match against arbitrary claims in the OIDC identity token. Patterns can
               include `*` characters to match against any character.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: A list of tags that access tokens generated for the federated identity will be able to assign to devices. Mandatory if
               the scopes include "devices:core" or "auth_keys".
        """
    ...
    def subject(self) -> pulumi.Input[_builtins.str]:
        """
        The pattern used when matching against the `sub` claim from an OIDC identity token. Patterns can include `*` characters
        to match against any character.
        """
    ...
    def audience(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The value used when matching against the `aud` claim from an OIDC identity token. Specifying the audience is optional as
        Tailscale will generate a secure audience at creation time by default. It is recommended to let Tailscale generate the
        audience unless the identity provider you are integrating with requires a specific audience format.
        """
    ...
    def custom_claim_rules(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]]:
        """
        A map of claim names to pattern strings used to match against arbitrary claims in the OIDC identity token. Patterns can
        include `*` characters to match against any character.
        """
    ...
    def tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        A list of tags that access tokens generated for the federated identity will be able to assign to devices. Mandatory if
        the scopes include "devices:core" or "auth_keys".
        """
...
class FederatedIdentity(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a FederatedIdentity resource with the given unique name, props, and options.
